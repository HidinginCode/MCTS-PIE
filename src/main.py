...
if __name__ == "__main__":
   simulations(map = "meandering_river_map", env_dim = 20, start = (0,10), goal=(19,10), budget=5000000, per_sim_budget=100, number_of_sims=1000, rollout_method=1, root_selection_method=1, tree_selection_method=0)
