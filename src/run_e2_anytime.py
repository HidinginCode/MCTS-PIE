"""E2 — Anytime / budget scaling: all 6 algorithms x 10 maps x 30 seeds x 5 budgets."""

from __future__ import annotations

import argparse

from experiments.config import ALGORITHMS, MAP_SUITE, SEEDS, RunSpec
from experiments.runner import run

OUT_DIR = "./log/e2_anytime"
FAMILY = "e2_anytime"
            ...
            for algo in ALGORITHMS:
                for budget in BUDGETS:
                    specs.append(RunSpec(
                        ...
                        seed=seed, total_budget=budget,
                        overrides={"budget_axis": budget},
                    ))
    return specs
